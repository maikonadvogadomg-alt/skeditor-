...
self.addEventListener("activate", (e) => {
  e.waitUntil(
    ...
    // NÃO força navegação dos clientes — isso causava tela branca após deploy
    // se o cliente atual ainda tivesse referência pra bundle antigo.
    // Em vez disso, na próxima abertura natural o cliente pega tudo novo via network-first.
  );
});
